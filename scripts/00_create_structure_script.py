...
def setup_virtual_environment(base_path):
    ...
    subprocess.run([str(pip_executable), "install"] + requirements, check=True)

if __name__ == "__main__":
    create_structure_with_content(BASE_PATH, structure)
    setup_virtual_environment(BASE_PATH)
    print("\n✅ Directory structure, virtual environment, and requirements installed successfully.")
